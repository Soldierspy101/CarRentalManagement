...
using CarRentalManagementPE_01.Server.Models;
...
namespace CarRentalManagementPE_01.Server.Repository
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private IGenericRepository<Colors> _colors;
        ...
        public IGenericRepository<Colors> Colors
            => _colors ??= new GenericRepository<Colors>(_context);
